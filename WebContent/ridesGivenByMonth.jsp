...
<title>Rides Given by Month</title>
</head>
<body>
...
<%
	try {	
		...
		String query = "SELECT COUNT(*) FROM acceptedOffers WHERE Extract(MONTH FROM acceptedOffers.Date) = '"+month+"' and acceptedOffers.Driver = '"+userid+"'";
