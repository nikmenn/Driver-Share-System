...
<title>Rides Given by Semester</title>
</head>
...
<%
	try {	
		...
		String query = "SELECT COUNT(*) FROM acceptedOffers WHERE Extract(QUARTER FROM acceptedOffers.Date) = '"+semester+"' and acceptedOffers.Driver = '"+userid+"'";
