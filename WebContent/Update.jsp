...
<%
	try {
	    ...
	    if(xdelete.equals("yes") ) {
	        String dele = "DELETE FROM driverOffer WHERE Username = ? and Date = ? and Deptime = ? ";
		...
		ps.executeUpdate();
	        ...
	        String update = "UPDATE driverOffer SET Departure = ?, Date = ?, Deptime = ?, Destination = ? WHERE Username = ? and Date = ? and Deptime = ?";
