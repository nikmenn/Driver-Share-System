...
<title>Update/Delete Submitted Rides</title>
</head>
<body>
<%
	try {	
		...
		String query = "SELECT * FROM driverOffer where Username = '" + userid + "'" ;
...
<form method="post" action="Update.jsp">
 Input the ride from above you want to update <br/> 
...
Would you like to delete this offer instead:  <select name="del" id="del">
