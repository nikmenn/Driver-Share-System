...
<title>Rides Taken By Month</title>
</head>
<body>
...
<%
	try {	
		...
		String query = "SELECT COUNT(*) FROM acceptedOffers WHERE Extract(MONTH FROM acceptedOffers.Date) = '"+month+"' and acceptedOffers.Passenger = '"+userid+"'";
